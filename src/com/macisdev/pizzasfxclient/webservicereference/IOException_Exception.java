 ...
 * 
 */
@WebFault(name = "IOException", targetNamespace = "http://pizzashopwebservice.macisdev.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.macisdev.pizzasfxclient.webservicereference.IOException
     */
